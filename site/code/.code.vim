...
badd +1 ProjectsListPage.php
badd +8 CustomSiteConfig.php
badd +2 Item.php
badd +0 Link.php
badd +0 ~/www/yh/urlField/code/LinkExternal.php
badd +0 ~/.vim/ftplugin/html/sparkup.vim
args HomePage.php
edit Project.php
...
20
normal! 011l
tabedit ~/.vim/ftplugin/html/sparkup.vim
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
4
normal zo
let s:l = 59 - ((25 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
