...
set report=0
set ruler
set runtimepath=~/.vim,~/.vim/bundle/vim-jade,~/.vim/bundle/vim-stylus,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set shiftwidth=4
set showmatch
set smartindent
set smarttab
...
badd +2 HomePage.php
badd +0 Project.php
badd +10 ProjectsHolderPage.php
badd +4 Category.php
badd +0 Page.php
badd +0 ProjectImage.php
badd +0 ProjectImagesAdmin.php
badd +0 ProjectsListPage.php
args HomePage.php
edit Project.php
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 41 - ((37 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
normal! 0
tabedit ProjectImagesAdmin.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
