...
class Page_Controller extends ContentController {
	...
	public function init() {
		if(Director::isDev()){
			//Requirements::javascript('site/javascript/jquery-1.7.1.min.js');
			//Requirements::javascript('site/javascript/jquery.easing.js');
			//Requirements::javascript('site/javascript/jquery.colorbox.js');
			//Requirements::javascript('site/javascript/jquery.isotope.js');
			//Requirements::javascript('site/javascript/main.js');
		}else{
			//Requirements::javascript('jemarch/javascript/jemarch.js');
		}
		parent::init();
	}
