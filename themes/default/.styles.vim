...
silent only
cd ~/www/yh/themes/default/styles
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +68 styles.styl
badd +1 typography.styl
badd +1 items.styl
badd +1 ../templates/Layout/ListPage.ss
badd +37 mixins.styl
badd +100 ../../../urlField/code/LinkExternal.php
badd +1 variables.styl
badd +1 ../../../site/code/ExtendedDataObject.php
badd +64 ../../../site/code/Project.php
args styles.styl
edit typography.styl
...
4
normal zo
let s:l = 20 - ((11 * winheight(0) + 11) / 22)
...
93
normal zo
let s:l = 21 - ((11 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 15 - ((8 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
15
normal! 020l
tabedit ../templates/Layout/ListPage.ss
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
4
normal zo
let s:l = 70 - ((13 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
normal! 01l
tabedit ../../../site/code/ExtendedDataObject.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
5
normal zo
let s:l = 56 - ((4 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
